...
export const MusubiConfigSchema = Type.Object({
    ...
    supplement: Type.Optional(Type.Object({
        enabled: Type.Optional(Type.Boolean()),
        planes: Type.Optional(Type.Array(Type.Union([
    ...
    thoughts: Type.Optional(Type.Object({
        enabled: Type.Optional(Type.Boolean()),
        reconnect: Type.Optional(Type.Object({
            maxBackoffMs: Type.Optional(Type.Number({ minimum: 1000, maximum: 600_000 })),
        }, { additionalProperties: false })),
    }, { additionalProperties: false })),
}, { additionalProperties: false });
export const DEFAULT_SUPPLEMENT_PLANES = ["curated", "concept"];
